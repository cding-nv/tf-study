...
static Status ReadEntireFile(tensorflow::Env* env, const string& filename,
    ...
    output->scalar<string>()() = std::string(data);//data.ToString();
...
int main(int argc, char** argv ) {
    ...
    std::cout << "Peak line " << __LINE__ << " start" << std::endl;
    ...
    std::cout << "Peak line " << __LINE__ << " " << resized_tensor.DebugString()<<endl;
    ...
    std::cout << "Peak line " << __LINE__ << "Begin to create session " << std::endl;
    ...
    std::cout << "Peak line " << __LINE__ << " session has run " << std::endl;
